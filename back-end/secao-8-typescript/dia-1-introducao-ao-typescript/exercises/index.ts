...
console.log(`A a área de um losango que tem D = 32cm e d = 18cm é: ${Ex.diamondArea(32, 18)}`);
console.log(`A a área de um losango que tem D = 200cm e d = 50cm é: ${Ex.diamondArea(200, 50)}`);
console.log(`A a área de um losango que tem D = 75cm e d = 25cm é: ${Ex.diamondArea(75, 25)}`);

console.log(`A área de um trapézio que tem B = 100cm, b = 70cm e altura = 50cm é: ${Ex.trapezeArea(100, 70, 50)}`)
console.log(`A área de um trapézio que tem B = 75cm, b = 50cm e altura = 35cm é: ${Ex.trapezeArea(75, 50, 35)}`)
console.log(`A área de um trapézio que tem B = 150cm, b = 120cm e altura = 80cm é: ${Ex.trapezeArea(150, 120, 80)}`)

console.log(`A área de um círculo de raio igual 25cm é: ${Ex.circleArea(25)}`);
console.log(`A área de um círculo de raio igual 100cm é: ${Ex.circleArea(100)}`);
console.log(`A área de um círculo de raio igual 12.5cm é: ${Ex.circleArea(12.5)}`);
